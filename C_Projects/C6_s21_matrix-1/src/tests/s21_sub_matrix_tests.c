...
START_TEST(sub_matrix_INCORRECT_COLUMS_1) {
  // Arrange
  int rows_1 = 5;
  int cols_1 = 5;
  ...
  // Act
  int error = s21_sub_matrix(&test_matrix_ptr_1, &test_matrix_ptr_2,
                             &test_matrix_ptr_3);
...
START_TEST(sub_matrix_INCORRECT_COLUMS_2) {
  // Arrange
  int rows_1 = 5;
  int cols_1 = 0;
  matrix_t test_matrix_ptr_1 = {0};
...
START_TEST(sub_matrix_INCORRECT_ROWS_1) {
  // Arrange
  int rows_1 = 9;
  int cols_1 = 5;
  matrix_t test_matrix_ptr_1 = {0};
...
START_TEST(sub_matrix_INCORRECT_ROWS_2) {
  // Arrange
  int rows_1 = 5;
  int cols_1 = 5;
  matrix_t test_matrix_ptr_1 = {0};
...
START_TEST(sub_matrix_INCORRECT_STRUCT_1) {
  // Arrange
  ...
  // Act
  int error =
      s21_sub_matrix(test_matrix_ptr_1, &test_matrix_ptr_2, &test_matrix_ptr_3);
  // s21_display_matrix(&test_matrix_ptr_1);
  // printf("\n");
  // s21_display_matrix(&test_matrix_ptr_2);
  // printf("\n%d\n", error);
...
START_TEST(sub_matrix_INCORRECT_STRUCT_2) {
  // Arrange
  int rows_1 = 5;
  int cols_1 = 5;
  matrix_t test_matrix_ptr_1 = {0};
...
START_TEST(sub_matrix_OK_1) {
  // Arrange
  int rows = 5;
  int cols = 5;
  matrix_t test_matrix_ptr_1 = {0};
  s21_create_matrix(rows, cols, &test_matrix_ptr_1);
  s21_fill_matrix(&test_matrix_ptr_1, MODE_NEG_REVERS_SEQUENCE);

  matrix_t test_matrix_ptr_2 = {0};
  s21_create_matrix(rows, cols, &test_matrix_ptr_2);
  s21_fill_matrix(&test_matrix_ptr_2, MODE_POS_SEQUENCE);
...
Suite *sub_matrix(void) {
  ...
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_COLUMS_1);
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_COLUMS_2);
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_ROWS_1);
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_ROWS_2);
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_STRUCT_1);
  tcase_add_test(sub_matrix, sub_matrix_INCORRECT_STRUCT_2);
  tcase_add_test(sub_matrix, sub_matrix_OK_1);
  tcase_add_test(sub_matrix, sub_matrix_OK_2);
  tcase_add_test(sub_matrix, sub_matrix_OK_3);
  tcase_add_test(sub_matrix, sub_matrix_OK_4);
